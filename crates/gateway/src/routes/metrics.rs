...
pub async fn metrics_handler(State(state): State<Arc<AppState>>) -> impl IntoResponse {
    ...
    output.push_str(&format!(
        "llm_smart_router_total_requests {} {}\n",
